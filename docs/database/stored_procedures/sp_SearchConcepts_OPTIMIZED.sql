-- ============================================================================
-- Stored Procedure: sp_SearchConcepts (OPTIMIZED with concept_search table)
-- ============================================================================
-- Purpose: Fast concept search using pre-computed search text and indexes
-- Performance: Uses concept_search table with optimized indexes
-- ============================================================================
